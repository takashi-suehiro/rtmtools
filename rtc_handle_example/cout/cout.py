...
cout_spec = ["implementation_id", "cout", 
		 "type_name",         "cout", 
...
class cout(OpenRTM_aist.DataFlowComponentBase):
...
def coutInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=cout_spec)
...
def MyModuleInit(manager):
    ...
    # Create a component
    comp = manager.createComponent("cout")
